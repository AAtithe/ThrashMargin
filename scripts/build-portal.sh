...
# Niccolo, The Tea Race, Steady Eddie and Thrash Margin's client builds under their own subpaths.
...
rm -rf dist
mkdir -p dist/niccolo dist/tea-race dist/steady-eddie dist/thrash-margin
cp -r landing/. dist/
