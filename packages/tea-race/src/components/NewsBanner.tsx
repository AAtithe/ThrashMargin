 ...
 * about four turns ago is still shutting the port you are steering for. Cards are the notification,
 * this is the state.
 */

import { FONT, UI } from '../theme';
import { goodName, portName } from '../sim/content';
...
function effect(e: WorldEvent): string {
  switch (e.kind) {
    case 'strike':
      return `${portName(e.port!)} shut — no lading, no landing`;
    case 'embargo':
